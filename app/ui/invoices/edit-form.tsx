...
export default function EditInvoiceForm({
  ...
  const [formState, submitAction] = useActionState<tInvoiceFormState, FormData>(updateInvoiceWithId, invoiceInitialState)
    ...
    <form action={submitAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <FormErrorField id='customer-error'>
        ...
        <div className="mb-4">
          ...
          <FormErrorField id='amount-error'>
        ...
        <fieldset>
          ...
          <FormErrorField id='status-error'>
